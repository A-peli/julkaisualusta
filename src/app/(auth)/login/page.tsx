...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-sm bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      ...
      {registered && <p className="text-green-700 text-sm bg-green-50 p-3 rounded mb-4">Rekisteröityminen onnistui! Kirjaudu nyt sisään.</p>}
...
export default function LoginPage() {
  return (
    <div className="min-h-[70vh] flex items-center justify-center">
      <Suspense fallback={<div className="w-full max-w-sm p-6 text-center text-gray-500">Ladataan…</div>}>
        <LoginForm />
      </Suspense>
    </div>
  );
